...
var developers = {
  "invader": {
	...
	"logo": "https://junaidjagirani.github.io/data/invader-pic.jpg"
  },
  "xbot": {
    "name": "Hamad ( MRxBOT )",
    "age": 27,
	...
	"logo": "https://junaidjagirani.github.io/data/MrxBot_Logo.png"
  },
  "camper": {
	...
	"logo": "https://junaidjagirani.github.io/data/camper.jpg"
  },
  "shahid": {
	...
	"logo": "https://junaidjagirani.github.io/data/shahid-jsqm.png"
  }
};
...
function showDeveloperInfo(name) {
  ...
  if (developerInfo) {
	document.getElementById("developerLogo").src = developerInfo.logo;
